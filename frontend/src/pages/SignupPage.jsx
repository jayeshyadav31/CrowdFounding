...
function SignupPage() {
    ...
    return (
        <div className='flex flex-col items-center justify-center w-60 min-w-96 mx-auto bg-slate-300 font-serif mb-14'>
                ...
                <form>
                    <div>
                        ...
                        <input
                            ...
                            className='w-full input pl-2 my-2 input-bordered h-10 border-2 border-gray-400 rounded-md'
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className='w-full input my-2 input-bordered h-10 pl-2 border-2 border-gray-400 rounded-md'
                            onChange={handleChange}
                        />
                    </div>
                    <div>
                    ...
                    <Link
                        to='/login'
                        className='text-sm text-blue-500 py-1 hover:underline hover:text-blue-600 mt-2 inline-block'>
